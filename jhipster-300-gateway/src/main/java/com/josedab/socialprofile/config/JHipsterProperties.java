...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "socialprofile@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "socialprofile API";

        private String description = "socialprofile API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "socialprofile";
